...
internal_id: A unique, incremental identifier for each person. Do not include the same person more than once.
...
personal_information: Relevant details about the person, such as their interests, hobbies, number of children, place of birth, 
or any other significant facts mentioned in the conversation.

Your response should be formatted as a single JSON object containing these records.
